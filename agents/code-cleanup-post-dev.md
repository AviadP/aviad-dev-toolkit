...
1. **Analyze Git Differences**: Compare the current codebase against remote/origin to identify newly added or modified code. Focus your cleanup efforts exclusively on these changes.
